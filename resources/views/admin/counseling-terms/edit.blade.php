<x-admin-layout>
    <x-slot name="header">
        Manage Counseling Terms & Conditions
    </x-slot>

    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.counseling-terms.update') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-800 mb-6 flex items-center">
                        <i class="fas fa-file-contract text-primary mr-2"></i> Counseling Terms Content
                    </h3>
                        ...
                        <div class="flex items-center gap-6">
                            @if($terms->image_path)
                                <div class="w-32 h-20 rounded-lg overflow-hidden border border-gray-200">
                                    <img src="{{ asset('storage/' . $terms->image_path) }}" alt="Current Hero" class="w-full h-full object-cover">
                                </div>
                            @endif
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mb-3">Use the editor below to format your terms and conditions.</p>
                        <textarea name="content" id="terms-editor" rows="20" class="w-full rounded-lg border border-gray-200" required>{{ old('content', $terms->content) }}</textarea>
                    ...
                    <div class="mb-8 border-t border-gray-100 pt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="meta_title" value="{{ old('meta_title', $terms->meta_title) }}" class="w-full rounded-lg border border-gray-200 px-4 py-2 focus:ring-primary focus:border-primary">
                                <p class="text-xs text-gray-500 mt-1">Recommended length: 50-60 characters</p>
                            </div>

                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Meta Description</label>
                                <textarea name="meta_description" rows="3" class="w-full rounded-lg border border-gray-200 px-4 py-2 focus:ring-primary focus:border-primary">{{ old('meta_description', $terms->meta_description) }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $terms->meta_keywords) }}" class="w-full rounded-lg border border-gray-200 px-4 py-2 focus:ring-primary focus:border-primary">
