<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.terms-and-condition.update') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-800 mb-6 flex items-center">
                        <i class="fas fa-file-contract text-primary mr-2"></i> Terms & Conditions Content
                    </h3>
