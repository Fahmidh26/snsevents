        ...
        <form action="{{ route('admin.event-types.update', $eventType) }}" method="POST" enctype="multipart/form-data" class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="category" list="categories" value="{{ old('category', $eventType->category) }}" required class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="e.g. Event Planning & Management">
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="meta_title" value="{{ old('meta_title', $eventType->meta_title) }}" maxlength="255" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="e.g. Birthday Party Planning - SNS Events">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="meta_description" rows="3" maxlength="500" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="Brief description for search engines...">{{ old('meta_description', $eventType->meta_description) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $eventType->meta_keywords) }}" maxlength="255" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="birthday, party planning, decorations, texas">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="og_title" value="{{ old('og_title', $eventType->og_title) }}" maxlength="255" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="Leave blank to use Meta Title">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="og_description" rows="3" maxlength="500" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" placeholder="Leave blank to use Meta Description">{{ old('og_description', $eventType->og_description) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if($eventType->og_image)
                            <div class="mb-2">
                                <img src="{{ asset($eventType->og_image) }}" alt="Current OG image" class="w-48 h-auto object-cover rounded-lg border border-gray-200">
                            </div>
                        @endif
                        ...
                        <p class="text-xs text-gray-500 mt-1">Recommended: 1200x630px. Leave blank to {{ $eventType->og_image ? 'keep current image' : 'use Featured Image' }}.</p>
