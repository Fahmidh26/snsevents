        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-primary">
            <div class="p-8 text-secondary">
                ...
                <div class="flex justify-between items-center mb-6">
                    <p class="text-gray-600">Manage frequently asked questions displayed on your website.</p>
                    <a href="{{ route('admin.faqs.create') }}" class="bg-primary hover:bg-accent text-white font-bold py-2 px-6 rounded-full shadow-md transform transition hover:-translate-y-1 hover:shadow-lg text-sm">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Answer Preview</th>
                            ...
                            @foreach($faqs as $faq)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.faqs.edit', $faq->id) }}" class="text-primary hover:text-accent mr-3">Edit</a>
