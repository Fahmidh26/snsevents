...
<style>
    ...
    .confirmation-hero h1 {
        ...
        font-weight: 700;
        margin-bottom: 15px;
        background: linear-gradient(135deg, #fff 0%, #48bb78 100%);
    ...
    .success-icon {
        ...
        box-shadow: 0 15px 40px rgba(72, 187, 120, 0.35);
    }
    ...
    .next-steps {
        background: linear-gradient(135deg, rgba(212, 175, 55, 0.08) 0%, rgba(201, 169, 97, 0.08) 100%);
        ...
        <div class="confirmation-card" data-aos="fade-up">
            ...
            <div class="booking-details">
                ...
                <div class="details-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="value price">${{ number_format($booking->slot->price, 2) }}</div>
                    </div>
                    <div class="detail-item">
            ...
            <div class="next-steps">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-check-circle"></i> You'll receive session details and connection instructions</li>
                    <li><i class="fas fa-check-circle"></i> Please be ready 5 minutes before your scheduled time</li>
                    <li><i class="fas fa-check-circle"></i> Find a quiet, private space for your session</li>
                </ul>
            </div>
            ...
            <div style="margin-bottom: 24px; padding: 18px 20px; background: #f8f4ff; border-radius: 12px; border: 1.5px solid #ede9fe;">
                ...
                @elseif($canReschedule)
                    ...
                    <a href="{{ route('counseling.reschedule', ['code' => $booking->confirmation_code]) }}"
