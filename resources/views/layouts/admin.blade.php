    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 z-50 w-64 bg-secondary text-white transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 shadow-xl flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto py-5 px-3 space-y-1 sidebar-scroll">
                ...
                <a href="{{ route('admin.navbar-items.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.navbar-items.*') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
                ...
                <a href="{{ route('admin.newsletter.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.newsletter.*') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
                    <i class="fas fa-envelope w-5 h-5 mr-3"></i>
                    Newsletter Subscriptions
                </a>

                <a href="{{ route('admin.contact-submissions.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.contact-submissions.*') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
                ...
                <p class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 mt-6">Management Session</p>

                <a href="{{ route('admin.management-session.settings') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.management-session.settings') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
                    <i class="fas fa-briefcase w-5 h-5 mr-3"></i>
                    Session Settings
                </a>

                <a href="{{ route('admin.management-session.slots') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.management-session.slots*') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
                    <i class="fas fa-clock w-5 h-5 mr-3"></i>
                    Manage Slots
                </a>

                <a href="{{ route('admin.management-session.bookings') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.management-session.bookings*') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
                    <i class="fas fa-calendar-check w-5 h-5 mr-3"></i>
                    View Bookings
                </a>
                ...
                <a href="{{ route('admin.counseling-terms.edit') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.counseling-terms.*') ? 'bg-primary/20 text-primary' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }} transition-colors">
